        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MRPAmount = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(nullable: false),
                    Count = table.Column<int>(nullable: false),
                    ItemAmount = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 10, "oppo1.png", true, "Mob-oppo-1", 15999.0, 3, "Oppo Reno 6" },
                    { 2, 4, 10, "vivo1.png", true, "Mob-vivo-1", 15999.0, 3, "Vivo X" },
                    { 3, 4, 10, "samsung1.png", true, "Mob-Sam-1", 15999.0, 3, "Samsung M31" },
                    { 4, 4, 10, "IPhone1.png", true, "Mob-iphone-1", 15999.0, 3, "Iphone 13 Max pro" }
                });
